// Generated from c:\Users\Brian\Desktop\thLangCompil\tp5\sources-MVaP-2.2\MVaP.g4 by ANTLR 4.7.1
...
public class MVaPLexer extends Lexer {
	...
	public static final String[] ruleNames = {
		...
		"RETURN", "POP", "POPF", "READ", "READF", "WRITE", "WRITEF", "PADD", "PUSHGP", 
	...
	private static final String[] _LITERAL_NAMES = {
		null, null, null, null, "'ADD'", "'SUB'", "'MUL'", "'DIV'", "'INF'", "'INFEQ'", 
		"'SUP'", "'SUPEQ'", "'EQUAL'", "'NEQ'", "'FADD'", "'FSUB'", "'FMUL'", 
		"'FDIV'", "'FINF'", "'FINFEQ'", "'FSUP'", "'FSUPEQ'", "'FEQUAL'", "'FNEQ'", 
		"'ITOF'", "'FTOI'", "'RETURN'", "'POP'", "'POPF'", "'READ'", "'READF'", 
		"'WRITE'", "'WRITEF'", "'PADD'", "'PUSHGP'", "'PUSHFP'", "'DUP'", "'PUSHI'", 
		"'PUSHG'", "'STOREG'", "'PUSHL'", "'STOREL'", "'PUSHR'", "'STORER'", "'FREE'", 
		"'ALLOC'", "'PUSHF'", "'CALL'", "'JUMP '", "'JUMPF'", "'JUMPI'", "'HALT'", 
		"'LABEL'"
	};
	private static final String[] _SYMBOLIC_NAMES = {
		...
		"POP", "POPF", "READ", "READF", "WRITE", "WRITEF", "PADD", "PUSHGP", "PUSHFP", 
